...
class Config(object):
    ...
    def __init__(self, type="CHROME"):
        ...
        # self.isSecondary = True
            ...
            raise Exception(f"不明なデバイスです。config.py に新しいデバイスを追加してください。")
        self.APP_TYPE = type
