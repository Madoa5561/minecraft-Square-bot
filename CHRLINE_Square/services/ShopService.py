...
class ShopService(object):
    ...
    def getProduct(self, shopId, productId, language="ja-JP", country="JP"):
        sqrd = [
            128,
            1,
            0,
    ...
    def canReceivePresent(self, shopId, productId, recipientMid):
        ...
        sqrd += [12, 0, 4]
        sqrd += [11, 0, 1] + self.getStringBytes("ja-JP")  # language
        sqrd += [11, 0, 2] + self.getStringBytes("JP")  # country
        sqrd += [0]
    ...
    def getOwnedProductSummaries(
        self, shopId, offset=0, limit=200, language="ja-JP", country="JP"
    ):
        sqrd = (
            [128, 1, 0, 1]
    ...
    def getUpdates(self, shopId: str, language: str = "ja-JP", country: str = "JP"):
        params = [
            [11, 2, shopId],
            [
                12,
